...
N = 6;
[moyennes, variances] = estimation(I,N,couleurs_classes);	% estimation (supervisée)

% tri des moyennes
[moyennes, I_moyennes] = sort(moyennes,'ascend');
variances = variances(:,I_moyennes);
couleurs_classes = couleurs_classes(I_moyennes,:);
